<template>
    ...
    <div class="applications-nav " >
      <h2 class="fw-bold ">Buddies</h2>
      <hr>
      <div class="form-group">
            <label class="label-text" for="usr">Update Username</label>
            <input type="text" placeholder="hello" class="form-control input px-2 mx-2" style="height: 40px;">
